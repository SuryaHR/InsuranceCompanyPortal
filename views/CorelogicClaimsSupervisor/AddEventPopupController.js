angular.module('MetronicApp').controller('AddEventPopupController', function ($rootScope,$filter, SupervisorClaimDetailsService, $uibModal, $scope, $translate, $translatePartialLoader, objClaim) {
