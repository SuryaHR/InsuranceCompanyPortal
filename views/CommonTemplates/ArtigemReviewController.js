angular.module('MetronicApp').controller('ArtigemReviewController', function ($rootScope,$timeout, $filter,$location, ArtigemReviewService, $uibModal, $scope, $translate, $translatePartialLoader,AppraisalService,appraisalData,
    AuthHeaderService) {
