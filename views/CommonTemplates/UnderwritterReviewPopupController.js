angular.module('MetronicApp').controller('UnderwritterReviewPopupController', function ($rootScope,$filter,$location, UnderWriterReviewService, $uibModal, $scope, $translate, $translatePartialLoader,AppraisalService, appraisalData, AuthHeaderService) {
        ...
        chainDetails = {
         ...
         "typeOfMetal": appraisalData.Appraisal.Chain.MetalType
            ...
            var details = {
                ...
                //display values
                "applicationSettingValueDTO":appraisalData.applicationSettingValueDTO,
