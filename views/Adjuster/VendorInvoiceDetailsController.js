angular.module('MetronicApp').controller('VendorInvoiceDetailsController', function ($rootScope, $filter, $uibModal, $scope, settings,
    ...
    function downloadInvoicePdf() {
        ...
        invoicePdfBytes.then(function (response) {
            ...
            startBlobDownload(blob, "INV-"+$scope.VendorInvoiceDetails.claimNumber+"-"+$scope.VendorInvoiceDetails.insured.lastName+","+$scope.VendorInvoiceDetails.insured.firstName+".pdf");
        });
