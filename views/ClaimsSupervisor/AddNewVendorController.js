angular.module('MetronicApp').controller('AddNewVendorController', function ($rootScope, SupervisorClaimDetailsService, $uibModal, $scope, settings, $http, $timeout,
    ...
    //set language
    $translatePartialLoader.addPart('AddNewVendor');
    $translate.refresh();
    ...
    function init() {
        ...
        var particiapntType = SupervisorClaimDetailsService.getParticipantType()
        ...
        var StateList = SupervisorClaimDetailsService.getStates(stateParam);
    ...
    $scope.searchExistingVendor = function () {
        ...
        var getResult = SupervisorClaimDetailsService.searchExistingEmployee(param)
    ...
    $scope.searchInternalEmployee = function () {
        ...
        var getResult = SupervisorClaimDetailsService.searchInternalEmployee(param)
        getResult.then(function (success) {
    ...
    function AddExternalParticipant() {
        ...
        var addExternalParticipant = SupervisorClaimDetailsService.addExternalParticipant(param);
    ...
    $scope.AddNewVendor = function () {
        ...
        var addNewVendor = SupervisorClaimDetailsService.addVendor(param);
    ...
    function AddParticipantForClaim(id, TypeId, Type) {
        ...
        var addParticiapnt = SupervisorClaimDetailsService.AddParticipantAgainstClaim(param);
