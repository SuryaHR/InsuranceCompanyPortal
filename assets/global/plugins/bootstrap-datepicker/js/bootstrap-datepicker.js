 ...
 */(function(factory){
	...
	function UTCDate(){
		/* CTB-1805 - Date defaulted date from 2000 if entered date year less than 4 degit*/
		if(arguments!=null && arguments[0].toString().length<4)
		  arguments[0] = 2000 + arguments[0];
		/* End - CTB-1805 changes */
	...
	Datepicker.prototype = {
      ...
      var element = this.component ? this.element.find('input') : this.element;
		...
		getFormattedDate: function(format){
			...
			return $.map(this.dates, function(d){
				/* CTB-1805 - Date defaulted date from 2000 if entered date year less than 4 degit*/
				if(parseInt(d!=null && d.getUTCFullYear()).toString().length<4)
				   d.setUTCFullYear(2000 + parseInt(d.getUTCFullYear()));
			    /* End - CTB-1805 changes */
		...
		getClassNames: function(date){
			/* Start - CTB-1805 changes */
			if(this.viewDate.getUTCFullYear().toString().length<4){
				this.viewDate.setUTCFullYear(this.viewDate.getUTCFullYear()+2000);
			}
			/* End - CTB-1805 changes */
			var cls = [],
